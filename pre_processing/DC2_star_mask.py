#!/usr/bin/env python
# coding: utf-8
# Study of DC2 stars to produce a mask for glaxies
...
str_healpix_pixel = str(3830)
###outpath
#outpath = "/sps/lsst/users/namourou/web/desc/clusters/DC2_mask/"
...
#function to print the content of hdf5 file
def get_all(name):
    print(name)
...
columns = ["objectId", "clean", "good", "extendedness","mag_i_cModel"]
...
galaxy_data_all = Table([galaxy_id, ra, dec, redshift, mag_g, mag_r, mag_i, mag_z, mag_y, zmode, photoz_pdf]#, match, clean, good, extend],
                        names=['id', 'ra', 'dec', 'redshift', 'mag_g', 'mag_r', 'mag_i', 'mag_z', 'mag_y', 'zmode', 'photoz_pdf']#, 'match', 'clean', 'good', 'extend'])

#define cut from the parquet tables
...
#print(table_xvals)
galaxy_data_cut.write(outpath+'galaxies.fits', overwrite = True)
table_xvals.write(outpath+'pdf_bins_noextend.fits', overwrite = True)
sys.exit()
