...
cd /pbs/home/n/namourou/test_jupyter/cluster_challenge/jobs/prepare_catalogs/

for tile in "${tiles[@]}" ;do
    echo 'submitted'
    #Run with mem = 64G if magnitude cats 
    sbatch -t 1:00:00 --cpus-per-task=1 --mem=64G --export=tile=${tile} run_py_subp.sh
    echo 'done'
