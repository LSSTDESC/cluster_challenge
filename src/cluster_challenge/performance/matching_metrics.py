...
from clevar.match import get_matched_pairs, output_matched_catalog, get_matched_masks
...
from src.pltFunc_matchingMetrics import make_ROC_curve
...
cats[cat2]['sz'] = np.zeros_like(cats[cat1]['mass'])
