...
cl_data = Table(fits.open(
	f"/sps/lsst/groups/clusters/cluster_comparison_project/initial_catalogs/wazp/DC2.fzb/wazp_cluster.fits")[1].data)
mb_data = Table(fits.open(
	f"/sps/lsst/groups/clusters/cluster_comparison_project/initial_catalogs/wazp/DC2.fzb/wazp_membership.fits")[1].data)
