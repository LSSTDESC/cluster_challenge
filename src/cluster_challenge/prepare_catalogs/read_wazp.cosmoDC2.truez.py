...
versions = [
	...
	'min_richness':0,
	'description':'WaZP run on cosmoDC2 with true redshifts',},
        {'v':'v1',
	'cat_name':'cosmoDC2_v1.1.4_wazp_v1.0_truez',
	'min_richness':20,
	'description':'WaZP run on cosmoDC2 with true redshifts',},
...
cl_data = Table(fits.open(
        f"/sps/lsst/groups/clusters/cluster_comparison_project/initial_catalogs/wazp/cosmoDC2.truez/wazp_cluster.fits")[1].data)
mb_data = Table(fits.open(
        f"/sps/lsst/groups/clusters/cluster_comparison_project/initial_catalogs/wazp/cosmoDC2.truez/wazp_membership.fits")[1].data)
