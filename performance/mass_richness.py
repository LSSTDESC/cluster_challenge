...
outpath = "/pbs/home/t/tguillem/web/clusters/cluster_challenge/mass_richness/redmapper/"
...
c_merged = ClCatalog.read(matching_folder+'output_catalog.fits', 'merged',  z_cl='cat1_z', richness = 'cat1_mass', z_halo='cat2_z', mass = 'cat2_mass', log_mass = 'cat2_log_mass')
